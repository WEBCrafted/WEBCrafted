...
if(
	...
	if($_POST["password"] != $_POST["password2"]) {
		...
		$_widgets->createWidget(2, "Socialhub", '<a href="https://www.facebook.com/"><img src="' . WEBROOT . 'assets/images/facebook.png" alt="facebook" /></a><a href="http://youtube.com/"><img src="' . WEBROOT . 'assets/images/youtube.png" alt="youtube" /></a><a href="https://twitter.com/"><img src="' . WEBROOT . 'assets/images/twitter.png" alt="twitter" /></a>');
